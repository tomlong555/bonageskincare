...
export function apiProductGroupListGet$Plain(http: HttpClient, rootUrl: string, params?: ApiProductGroupListGet$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<boolean>> {
